  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="mx-auto max-w-6xl px-6">
            <div className="grid gap-12 md:grid-cols-3">
              <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-100">
                ...
                <h3 className="mb-2 text-xl font-bold text-slate-900">Clear Visualization</h3>
                <p className="text-slate-600">Dynamic charts that update automatically.</p>
              </div>
              <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-100">
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-purple-50 text-purple-600">
                  <Users className="h-6 w-6" />
                </div>
                <h3 className="mb-2 text-xl font-bold text-slate-900">Fair Split Logic</h3>
                <p className="text-slate-600">Calculate risk-adjusted value for labor and cash.</p>
              </div>
              <div className="rounded-2xl bg-white p-8 shadow-sm border border-slate-100">
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600">
                  <ShieldCheck className="h-6 w-6" />
                </div>
                <h3 className="mb-2 text-xl font-bold text-slate-900">Secure Record</h3>
                <p className="text-slate-600">Keep an immutable history of all contributions.</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-slate-100 bg-white py-12">
        <div className="mx-auto max-w-6xl px-6 text-center">
          <p className="text-sm text-slate-500">© 2026 Equily. Built for founders.</p>
        </div>
      </footer>
    </div>
  );
