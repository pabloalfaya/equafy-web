    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-900 selection:bg-emerald-100 selection:text-emerald-900 overflow-x-hidden">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden lg:flex items-center gap-1 bg-slate-100/50 p-1 rounded-full border border-slate-200/50 backdrop-blur-md">
              {[
                { name: "Product", href: "/what-is-equily" },
          ...
          <div className="flex items-center gap-4">
            <Link href="/dashboard" className="hidden md:block text-sm font-bold text-slate-600 hover:text-slate-900 transition-colors">Log in</Link>
      ...
      <header className="relative pt-32 pb-20 z-10">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-white/80 border border-emerald-100 px-3 py-1 pr-4 text-xs font-bold text-emerald-700 mb-8 shadow-sm hover:border-emerald-200 transition-colors cursor-default backdrop-blur-sm">
            <span className="flex h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
            <span className="uppercase tracking-wide">v2.0 Released</span>
            <span className="text-slate-300">|</span>
            <span>Smart Dynamic Split</span>
          </div>

          <h1 className="text-6xl md:text-8xl font-bold tracking-tighter text-slate-900 mb-8 leading-[1.1] md:leading-[1.1]">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-xl text-slate-500 leading-relaxed font-medium">
      ...
      {/* --- DASHBOARD PREVIEW (CAP TABLE LIVE) --- */}
      <section className="pb-32 relative z-10 px-4">
        <div className="mx-auto max-w-6xl">
          {/* Efecto de brillo trasero */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] h-[80%] bg-emerald-500/20 blur-[100px] rounded-full -z-10"></div>
          
          {/* Contenedor tipo Ventana de App */}
          <div className="rounded-[32px] border border-slate-200/60 bg-white/80 backdrop-blur-2xl shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] overflow-hidden ring-1 ring-slate-900/5">
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative flex items-center justify-center py-8">
                  <div className="relative h-72 w-72">
                    {/* SVG Chart con animación de entrada */}
      ...
      <section className="py-32 relative z-10 bg-[#0B0F19] text-white">
        {/* Decoración de fondo oscuro */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-900/30 via-[#0B0F19] to-[#0B0F19]"></div>
        ...
        <div className="mx-auto max-w-7xl px-6 relative">
          ...
          <div className="grid lg:grid-cols-3 gap-6 items-start">
            ...
            <div className="relative bg-emerald-900/10 border border-emerald-500/50 rounded-[32px] p-8 transition-all duration-300 shadow-[0_0_80px_-20px_rgba(16,185,129,0.2)] h-full flex flex-col transform lg:-translate-y-4">
              ...
              <div className="space-y-6 mb-8 flex-grow">
                ...
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-4">
                    ...
                    <p className="text-xs text-blue-200/60 mt-2 font-medium">Aportaciones tangibles e intangibles</p>
                </div>
