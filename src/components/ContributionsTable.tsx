          ...
          {contributions.map((c: any) => {
            ...
            return (
              <tr key={c.id} className="group hover:bg-slate-50/40 transition-all duration-200">
                ...
                <td className="px-6 py-5 text-sm font-medium text-slate-500 max-w-[180px] truncate">{displayDesc}</td>
                ...
                <td className="px-6 py-5 text-right font-black text-emerald-600 font-mono text-sm">
                  {percentage}%
                </td>
